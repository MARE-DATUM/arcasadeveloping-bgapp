        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              <div className="text-2xl font-bold text-blue-600">{data.summary.apis_successful}/3</div>
              <div className="text-sm text-gray-600">APIs Funcionais</div>
            </div>
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <div className="text-2xl font-bold text-green-600">{data.summary.total_products_found}</div>
              <div className="text-sm text-gray-600">Produtos Encontrados</div>
            </div>
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              <div className="text-2xl font-bold text-purple-600">{data.summary.response_time_ms}ms</div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <span className="ml-2">2.0.0-TOTP</span>
            </div>
          </div>
        </CardContent>
      </Card>
